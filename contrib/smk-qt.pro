...
RESOURCES += src/qt/smk.qrc src/qt/smk_locale.qrc

TRANSLATIONS += src/qt/locale/smk_bg.ts \
                src/qt/locale/smk_de.ts \
                src/qt/locale/smk_en.ts \
                src/qt/locale/smk_es.ts \
                src/qt/locale/smk_fi.ts \
                src/qt/locale/smk_fr.ts \
                src/qt/locale/smk_it.ts \
                src/qt/locale/smk_ja.ts \
                src/qt/locale/smk_pl.ts \
                src/qt/locale/smk_pt.ts \
                src/qt/locale/smk_ru.ts \
                src/qt/locale/smk_sk.ts \
                src/qt/locale/smk_sv.ts \
                src/qt/locale/smk_vi.ts \
                src/qt/locale/smk_zh_CN.ts \
                src/qt/locale/smk_zh_TW.ts
