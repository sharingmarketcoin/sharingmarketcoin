...
In order to support loading of multiple wallets in smk-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is smk.cpp.
...
Changes to smk.cpp
----------------------
smk.cpp is the entry point into smk-qt, and as such, will require some minor modifications to provide hooks for
