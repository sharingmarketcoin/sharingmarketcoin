...
// Copyright (c) 2015-2016 The Sharingmarket developers
...
private:
    ...
    /// Get 10000 SMK input that can be used for the Masternode
...
{
public:
    /// Is the inputs associated with this public key? (and there is 10000 SMK - checking if valid masternode)
