...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SMK features */
        {"smk", "masternode", &masternode, true, true, false},
        {"smk", "masternodelist", &masternodelist, true, true, false},
        {"smk", "mnbudget", &mnbudget, true, true, false},
        {"smk", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"smk", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"smk", "mnsync", &mnsync, true, true, false},
        {"smk", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use smkd, or the -server option to smk-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> smk-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:23233/\n";
}
