                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SHARINGMARKET-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SMK address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and smk: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SMK Core"), this);
    aboutAction->setStatusTip(tr("Show information about SMK Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SMK"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SMK addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SMK addresses"));
    ...
    openAction->setStatusTip(tr("Open a SMK: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SMK Core help message to get a list with possible SMK command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SMK Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SMK network", "", count));
}
...
{
    QString strTitle = tr("SMK Core"); // default title
