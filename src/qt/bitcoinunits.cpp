...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(SMK);
    unitlist.append(mSMK);
    unitlist.append(uSMK);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case SMK:
            return QString("tSMK");
        case mSMK:
            return QString("mtSMK");
        case uSMK:
            return QString::fromUtf8("μtSMK");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case SMK:
            return QString("SMK");
        case mSMK:
            return QString("Milli-SMK (1 / 1" THIN_SP_UTF8 "000)");
        case uSMK:
            return QString("Micro-SMK (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case SMK:
            return QString("TestSMKs");
        case mSMK:
            return QString("Milli-TestSMK (1 / 1" THIN_SP_UTF8 "000)");
        case uSMK:
            return QString("Micro-TestSMK (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
